...
tank_record_db = "tank_record.db"

# 一、坦克通讯与控制
#-----------------------------------------------------------------------------------0
# 1. 与初始化接口通讯
data_json = {"data":{"host":tank_init_ip,"port":tank_init_port,"db":tank_init_db,"db_table":task_name}} 
...
# 2. 与坦克数据存储接口通讯
data_json = {"data":{"db":tank_record_db,"record_all":1}} 
head = {"Content-Type": "application/json; charset=UTF-8", 'Connection': 'close'}
